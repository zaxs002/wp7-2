	...
	if( !$('#primary').hasClass('sidebar-no') ) {
		...
		$('.content').removeClass('span9').addClass('span12');
				...
				<div class="row">
					<div class="span12">
						<ul class="filters">
							<li class="all"><a class="active all" href="<?php echo add_query_arg('cat', '') ?>" data-option-value="*"><?php _e('All Categories', 'yit') ?></a></li>
							<?php if(!empty($cats)): ?>
 				...
 				<div class="row">
 		            <ul id="portfolio" class="<?php echo $portfolio_type; ?> filterable thumbnails">         
                        ...
                        <li <?php yit_work_class( $classes ) ?>>
							...
							<div class="ch-item<?php if ( $lightbox || $details || $title ) : ?> ch-item-hover<?php endif ?>" style="background: url('<?php yit_image( "id=$image_id&size=thumb_portfolio_4cols&output=url" ); ?>') no-repeat center;">
