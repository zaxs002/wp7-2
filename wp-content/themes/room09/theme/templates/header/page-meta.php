...
$show_breadcrumb = ( is_page() ? yit_get_post_meta( $post_id, '_show-breadcrumb' ) : ( bool ) yit_get_option('breadcrumb') ) && ( ! function_exists('is_shop') || ! is_shop() && !is_product() );

if ( ! $show_title && ! $show_breadcrumb ) return;
