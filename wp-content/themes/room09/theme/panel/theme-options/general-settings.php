...
function yit_tab_general_settings( $fields ) {
    ...
    $fields[120] = array(
        ...
        'desc' => __( 'This is an advanced setting that allows you remove query strings from static contents (eg. the ?v=3.5.1 string from CSS and JS files).', 'yit') . ' <a href="http://gtmetrix.com/remove-query-strings-from-static-resources.html">' . __( 'More info', 'yit' ) . '</a>',
        'std'  => 0
    );
