...
function yit_submenu_tabs_theme_option_colors_footer( $items ) {
    ...
    unset( $items[10], $items[20], $items[30] );
        ...
        $items[10] = array(
            ...
            'std' => apply_filters( 'yit_background-footer_std', '#93866d' ),
        ...
        $items[20] = array(
            ...
            'std' => YIT_IMAGES_URL . '/bg-footer.png'
        );
        $items[30] = array(
		...
		$items[110] = array(
                ...
                'std' => apply_filters( 'yit_copyright-borders-color_std', '#aa9d82' ),
...
add_filter( 'yit_copyright-background_std', create_function( '', 'return "#93866d";' ) );