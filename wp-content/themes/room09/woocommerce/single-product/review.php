				...
				<p class="meta">
					<strong itemprop="author"><?php comment_author(); ?></strong> <?php
						...
						if ( get_option('woocommerce_review_rating_verification_label') == 'yes' )
							if ( ( function_exists( 'wc_customer_bought_product' ) ) ? wc_customer_bought_product( $GLOBALS['comment']->comment_author_email, $GLOBALS['comment']->user_id, $post->ID ) : woocommerce_customer_bought_product( $GLOBALS['comment']->comment_author_email, $GLOBALS['comment']->user_id, $post->ID ) )
