...
class popular_posts extends WP_Widget {
    function popular_posts() {
        ...
        $this->WP_Widget( 'popular-posts', __('Popular Posts', 'yit'), $widget_ops, $control_ops );
    }
    ...
    function widget( $args, $instance ) {
        ...
        echo do_shortcode( '[popularpost items="'.$items.'" readmore="'.str_replace( '"', "'", do_shortcode( $more_text ) ).'" showthumb="'.$show_thumb.'" excerpt_length="'.$excerpt_length.'" date="'.$date.'"]' );
