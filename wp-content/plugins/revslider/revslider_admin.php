<?php
	...
	class RevSliderAdmin extends UniteBaseAdminClassRev{
		...
		public function addActivateNotification(){
			...
			?>
			<div class="updated below-h2 rs-update-notice-wrap" style="margin-left: 0; display:none" id="message"><a href="javascript:void(0);" style="float: right;" id="rs-dismiss-notice">×</a><p><?php _e('Hi! Please activate your copy of the Revolution Slider to receive automatic updates & get premium support.',REVSLIDER_TEXTDOMAIN); ?></p></div>
