...
?>
	...
	<div class='wrap'>
		...
		<div style="border:1px solid #e5e5e5; padding:15px 15px 15px 80px; border-radius:5px;-moz-border-radius:5px;-webkit-border-radius:5px;position:relative;overflow:hidden;background:#f1f1f1">		
			<div class="revyellow" style="left:0px;top:0px;position:absolute;height:100%;padding:30px 10px;"><i style="color:#fff;font-size:25px" class="revicon-arrows-ccw"></i></div>
		...
		<div class="title_line">
			<div class="view_title"><span style="margin-right:10px"><?php _e("Activate This Product",REVSLIDER_TEXTDOMAIN) ?></span><a style="vertical-align:middle" class='button-primary revblue' href='#' id="benefitsbutton"><?php _e("Why is this Important ?",REVSLIDER_TEXTDOMAIN)?> </a></div>
		</div>
		...
		<div id="benefitscontent" style="margin-top:10px;margin-bottom:10px;display:none;border:1px solid #e5e5e5; padding:15px 15px 15px 80px; border-radius:5px;-moz-border-radius:5px;-webkit-border-radius:5px;position:relative;overflow:hidden;background-color:#fff;">		
			<div class="revblue" style="left:0px;top:0px;position:absolute;height:100%;padding:30px 10px;"><i style="color:#fff;font-size:25px" class="revicon-doc"></i></div>
		...
		VALIDATION
		-->
		<div  style="border:1px solid #e5e5e5; margin-top:10px;padding:15px 15px 15px 80px; border-radius:5px;-moz-border-radius:5px;-webkit-border-radius:5px;position:relative;overflow:hidden;background:#f1f1f1">		
		...
		<div style="border:1px solid #e5e5e5;  height:500px;padding:25px 15px 15px 80px; border-radius:5px;-moz-border-radius:5px;-webkit-border-radius:5px;position:relative;overflow:hidden;background:#f1f1f1">		
			<div class="revpurple" style="left:0px;top:0px;position:absolute;height:100%;padding:30px 10px;"><i style="color:#fff;font-size:27px" class="eg-icon-back-in-time"></i></div>
